...
//Descrição: Aplicação do padrão GOF - Estrutural - FlyWeight Desafio
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function montarPizza() {
        ...
        custo_array.push(custo)

        /*     console.log(pedidos)
            console.log(custo_array) */
...
class Client {
    ...
    run() {
        ...
        for (let i = 0; i < letras.length; i++) {
            letras[i] = this.flyWeightFactory.getFlyweight(pedidos[i])

            letras[i].operation('pedido ', i)
        }
